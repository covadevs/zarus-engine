...
public class FramerateService implements Updatable {
	...
	private AtomicLong framerateCount = new AtomicLong(0);
	...
	public void render(Graphics g) {
		...
		DebugWriter.logRight("FPS: " + this.framerateToRender + "("+ DecimalFormat.getInstance().format(this.deltaToRender) + "ms)", g);
	}
